...
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.github.ooftf/image-preview/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.github.ooftf/image-preview)
 ### 特点
   * 1.支持自定义图片加载框架。
...
```grade
  compile 'com.github.ooftf:image-preview:2.2.9'
```
